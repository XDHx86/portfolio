...
const BOOT_LINES = [
  "Portfolio OS v2.0.26 [XDHx86 Edition]",
  "Loading modules... done.",
  "Initializing file system... done.",
  "AI assistant ready.",
  "",
  'Type \x1b[32m"help"\x1b[0m to see available commands.',
  'Type \x1b[32m"ai <message>"\x1b[0m to chat with an AI that knows about XDHx86.',
  "",
];
...
function Terminal({ onClose, hideHeader = false, transferBuffer, transferState }: TerminalProps) {
  ...
  const getPrompt = useCallback(() => {
    ...
    return `\x1b[32mxdhx86@portfolio:${currentDirRef.current}$\x1b[0m `;
  }, []);
  ...
  const enterChatMode = useCallback(() => {
    ...
    term.writeln(`\x1b[90mChat with an AI that knows about XDHx86.`);
